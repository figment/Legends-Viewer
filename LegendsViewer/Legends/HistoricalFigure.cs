...
namespace LegendsViewer.Legends
{
    public class HistoricalFigure : WorldObject
    {
        ...
        private void InternalMerge(List<Property> properties, World world)
        {
            ...
            List<string> knownRelationshipProfileProperties = new List<string>() { "hf_id", "meet_count", "last_meet_year", "last_meet_seconds72",
                "rep_friendly", "rep_buddy", "rep_grudge", "rep_trade_partner", "rep_quarreler" };
